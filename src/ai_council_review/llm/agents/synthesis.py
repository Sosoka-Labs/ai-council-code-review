...
class SynthesisAgent:
    """Merges all agent outputs into a single coherent review."""
    ...
    def __init__(self, config: Any) -> None:
        ...
        """
        self.config = config
        self.agent_config = config.agents.get("synthesis", None)
    ...
    def run(self, state: ReviewState) -> SynthesisOutput:
        ...
        try:
            structured_model = self.llm.with_structured_output(SynthesisOutput)
            ...
            return self._fallback_synthesize(all_findings)

    def _fallback_synthesize(self, all_findings: list[dict[str, Any]]) -> SynthesisOutput:
