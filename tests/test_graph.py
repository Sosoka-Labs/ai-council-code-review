...
class TestIngestNode:
    ...
    def test_ingest_node(self, monkeypatch: pytest.MonkeyPatch) -> None:
        ...
        with patch("ai_council_review.graph.PRIngestor") as mock_ingestor:
            ...
            with patch("ai_council_review.graph.GitHubClient") as mock_client:
...
class TestRouterNode:
    ...
    def test_router_node(self) -> None:
        ...
        with patch("ai_council_review.graph.RouterAgent") as mock_router:
            mock_instance = MagicMock()
...
class TestPostNode:
    ...
    def test_post_node(self, monkeypatch: pytest.MonkeyPatch) -> None:
        ...
        with (
            patch("ai_council_review.graph.GitHubClient"),
            patch("ai_council_review.graph.Publisher") as mock_publisher,
        ):
    ...
    def test_post_node_skipped(self, monkeypatch: pytest.MonkeyPatch) -> None:
        ...
        with patch("ai_council_review.graph.Publisher") as mock_publisher:
            result = post_node(state, config)
